...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 6226220158025482713, ; hash 0x5667fa3eec7c41d9, from name: aot-Zettelkasten.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Zettelkasten.dll.so
		ptr null; void* handle (0x0)
	}, ; 137
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6865303436598688009, ; hash 0x5f46751a05bbb909, from name: Zettelkasten
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Zettelkasten.dll.so
		ptr null; void* handle (0x0)
	}, ; 153
	...
	%struct.DSOCacheEntry {
		i64 8395973094424338210, ; hash 0x74847d0bace65f22, from name: libaot-Zettelkasten.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Zettelkasten.dll.so
		ptr null; void* handle (0x0)
	}, ; 203
	...
	%struct.DSOCacheEntry {
		i64 12133050426753426589, ; hash 0xa8614114588a249d, from name: Zettelkasten.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Zettelkasten.dll.so
		ptr null; void* handle (0x0)
	}, ; 310
	...
	%struct.DSOCacheEntry {
		i64 15483598698517005665, ; hash 0xd6e0cafb0dce8561, from name: libaot-Zettelkasten
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Zettelkasten.dll.so
		ptr null; void* handle (0x0)
	}, ; 403
	...
	%struct.DSOCacheEntry {
		i64 18418534762783136880, ; hash 0xff9bc7c7fadf5c70, from name: aot-Zettelkasten
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Zettelkasten.dll.so
		ptr null; void* handle (0x0)
	}, ; 478
...
@.env.3 = private unnamed_addr constant [37 x i8] c"4a8f8c65-7693-46c2-868c-02ed84a68b6a\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [27 x i8] c"libaot-Zettelkasten.dll.so\00", align 16
